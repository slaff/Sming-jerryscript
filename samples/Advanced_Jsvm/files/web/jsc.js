...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 538496,
    DYNAMIC_BASE = 5781376,
    DYNAMICTOP_PTR = 538336;
...
var ASM_CONSTS = {
  1024: function() {throw new Error ('Input must be valid UTF-8');},  
 1075: function($0) {throw new Error (UTF8ToString ($0));}
};
...
var asmGlobalArg = {};
var asmLibraryArg = { "alignfault": alignfault, "args_get": _args_get, "args_sizes_get": _args_sizes_get, "emscripten_asm_const_iii": _emscripten_asm_const_iii, "emscripten_get_sbrk_ptr": _emscripten_get_sbrk_ptr, "emscripten_longjmp": _emscripten_longjmp, "getTempRet0": _getTempRet0, "invoke_ii": invoke_ii, "invoke_iii": invoke_iii, "invoke_iiii": invoke_iiii, "invoke_iiiii": invoke_iiiii, "invoke_vi": invoke_vi, "invoke_vii": invoke_vii, "invoke_viii": invoke_viii, "invoke_viiiii": invoke_viiiii, "proc_exit": _proc_exit, "saveSetjmp": _saveSetjmp, "segfault": segfault, "setTempRet0": _setTempRet0, "testSetjmp": _testSetjmp };
var asm = createWasm();
Module["asm"] = asm;
